 ...
 * com.example.gebruiker.madlibs.Story.java
 * Madlibs
 *
 ...
 * A com.example.gebruiker.madlibs.Story is Serializable, so it can be packed into an Intent as "extra" data.
 */
...
public class Story implements Serializable {
    ...
    /** constructs a new com.example.gebruiker.madlibs.Story reading its text from the given input stream */
